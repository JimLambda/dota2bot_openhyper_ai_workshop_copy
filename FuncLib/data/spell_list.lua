...
function a.GetSpellReplaceWeight(b)
	for c, d in pairs(a["spells"]) do
		if a["spells"][c] and a["spells"][c][b] then
			return a["spells"][c][b].weight
		end
	end
	return 1
end
function a.GetSpellHeroName(b)
	for c, d in pairs(a["spells"]) do
		if a["spells"][c] and a["spells"][c][b] then
			return c
		end
