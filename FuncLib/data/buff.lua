local a = {}
a.creep_is_immune = { "modifier_fountain_glyph", "modifier_crystal_maiden_frostbite" }
a.enemy_is_immune = {
...
a.enemy_is_undead =
	{ "modifier_dazzle_shallow_grave", "modifier_oracle_false_promise_timer", "modifier_abaddon_borrowed_time" }
a.enemy_not_illusion = {
...
a.hero_not_invisible =
	{ "modifier_item_dustofappearance", "modifier_sniper_assassinate", "modifier_bounty_hunter_track" }
return a
