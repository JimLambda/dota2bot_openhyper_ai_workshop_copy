return {
	...
	{ sRawName = "item_necronomicon", sShortName = "itemNull", sCnName = "死灵书", sEnName = "Necronomicon" },
	{
		...
		sShortName = "itemNull",
		sCnName = "死灵书2",
		sEnName = "Necronomicon Level 2",
	},
	{
		sRawName = "item_necronomicon_3",
		sShortName = "itemNull",
		sCnName = "死灵书3",
		sEnName = "Necronomicon Level 3",
	},
	...
	{ sRawName = "item_travel_boots", sShortName = "itemNull", sCnName = "远行鞋", sEnName = "Boots of Travel" },
	{
		...
		sShortName = "itemNull",
		sCnName = "远行鞋2",
		sEnName = "Boots of Travel Level 2",
	},
	...
	{ sRawName = "item_double_tango", sShortName = "itemNull", sCnName = "两个树之祭祀", sEnName = "Two Tangos" },
	{
		...
		sShortName = "itemNull",
		sCnName = "两个净化药水",
		sEnName = "Two Clarities",
	},
	{
		sRawName = "item_double_flask",
		sShortName = "itemNull",
		sCnName = "两个治疗药膏",
		sEnName = "Two Healing Salves",
	},
	{
		sRawName = "item_double_enchanted_mango",
		sShortName = "itemNull",
		sCnName = "两个魔法芒果",
		sEnName = "Two Enchanted Mangos",
	},
	{
		sRawName = "item_double_branches",
		sShortName = "itemNull",
		sCnName = "两个铁树枝干",
		sEnName = "Two Iron Branches",
	},
	{ sRawName = "item_double_circlet", sShortName = "itemNull", sCnName = "两个圆环", sEnName = "Two Circlets" },
	{
		...
		sShortName = "itemNull",
		sCnName = "两个敏捷便鞋",
		sEnName = "Two Slippers of Agility",
	},
	{
		sRawName = "item_double_mantle",
		sShortName = "itemNull",
		sCnName = "两个智力斗篷",
		sEnName = "Two Mantles of Intelligence",
	},
	{
		sRawName = "item_double_gauntlets",
		sShortName = "itemNull",
		sCnName = "两个力量手套",
		sEnName = "Two Gauntlets of Strength",
	},
	{
		sRawName = "item_double_wraith_band",
		sShortName = "itemNull",
		sCnName = "两个怨灵系带",
		sEnName = "Two Wraith Bands",
	},
	{
		sRawName = "item_double_null_talisman",
		sShortName = "itemNull",
		sCnName = "两个空灵挂件",
		sEnName = "Two Null Talismans",
	},
	...
	{ sRawName = "item_wizard_hat", sShortName = "itemNull", sCnName = "巫师帽", sEnName = "Wizard Hat" },
	{ sRawName = "item_chasm_stone", sShortName = "itemNull", sCnName = "裂隙之石", sEnName = "Chasm Stone" },
	{ sRawName = "item_splintmail", sShortName = "itemNull", sCnName = "片甲", sEnName = "Splintmail" },
	{ sRawName = "item_shawl", sShortName = "itemNull", sCnName = "披巾", sEnName = "Shawl" },
	{
		sRawName = "item_essence_distiller",
		sShortName = "itemNull",
		sCnName = "精之灵器",
		sEnName = "Essence Distiller",
	},
	{
	...
	{ sRawName = "item_hydras_breath", sShortName = "itemNull", sCnName = "怪蛇之息", sEnName = "Hydra's Breath" },
	{
		sRawName = "item_consecrated_wraps",
		sShortName = "itemNull",
		sCnName = "圣化护服",
		sEnName = "Consecrated Wraps",
	},
	{
		sRawName = "item_crellas_crozier",
		sShortName = "itemNull",
		sCnName = "克莱拉牧杖",
		sEnName = "Crella's Crozier",
	},
	{
		sRawName = "item_dagger_of_ristul",
		sShortName = "itemNull",
		sCnName = "瑞斯图尔尖匕",
		sEnName = "Dagger of Ristul",
	},
	{ sRawName = "item_foragers_kit", sShortName = "itemNull", sCnName = "采菌套具", sEnName = "Forager's Kit" },
	{
		sRawName = "item_stonefeather_satchel",
		sShortName = "itemNull",
		sCnName = "石羽小包",
		sEnName = "Stonefeather Satchel",
	},
	{ sRawName = "item_kobold_cup", sShortName = "itemNull", sCnName = "狗头人酒杯", sEnName = "Kobold Cup" },
	{ sRawName = "item_dormant_curio", sShortName = "itemNull", sCnName = "蛰伏奇物", sEnName = "Dormant Curio" },
	{ sRawName = "item_weighted_dice", sShortName = "itemNull", sCnName = "加重骰子", sEnName = "Weighted Dice" },
	{
		sRawName = "item_ash_legion_shield",
		sShortName = "itemNull",
		sCnName = "余烬军团战盾",
		sEnName = "Ash Legion Shield",
	},
	{
		sRawName = "item_duelist_gloves",
		sShortName = "itemNull",
		sCnName = "决斗者手套",
		sEnName = "Duelist Gloves",
	},
	{
		sRawName = "item_poor_mans_shield",
		sShortName = "itemNull",
	...
	{ sRawName = "item_defiant_shell", sShortName = "itemNull", sCnName = "坚抗之壳", sEnName = "Defiant Shell" },
	{
	...
	{ sRawName = "item_searing_signet", sShortName = "itemNull", sCnName = "炽热纹章", sEnName = "Searing Signet" },
	{ sRawName = "item_mana_draught", sShortName = "itemNull", sCnName = "魔法饮剂", sEnName = "Mana Draught" },
	{ sRawName = "item_spellslinger", sShortName = "itemNull", sCnName = "咏咒之坠", sEnName = "Spellslinger" },
	{
		sRawName = "item_partisans_brand",
		sShortName = "itemNull",
		sCnName = "天游烙印",
		sEnName = "Partisan's Brand",
	},
	{
		sRawName = "item_jidi_pollen_bag",
		sShortName = "itemNull",
		sCnName = "基迪花粉袋",
		sEnName = "Jidi Pollen Bag",
	},
	{ sRawName = "item_serrated_shiv", sShortName = "itemNull", sCnName = "锯齿短刀", sEnName = "Serrated Shiv" },
	{
		sRawName = "item_gunpowder_gauntlets",
		sShortName = "itemNull",
		sCnName = "火药手套",
		sEnName = "Gunpowder Gauntlets",
	},
	{
		sRawName = "item_unrelenting_eye",
		sShortName = "itemNull",
		sCnName = "不懈之眼",
		sEnName = "Unrelenting Eye",
	},
	{ sRawName = "item_giant_maul", sShortName = "itemNull", sCnName = "巨人重锤", sEnName = "Giant's Maul" },
	{ sRawName = "item_rattlecage", sShortName = "itemNull", sCnName = "回响之笼", sEnName = "Rattlecage" },
	{
		sRawName = "item_idol_of_screeauk",
		sShortName = "itemNull",
		sCnName = "斯奎欧克之像",
		sEnName = "Idol of Scree'auk",
	},
	{ sRawName = "item_flayers_bota", sShortName = "itemNull", sCnName = "剥皮者之靴", sEnName = "Flayer's Bota" },
	{
		sRawName = "item_metamorphic_mandible",
		sShortName = "itemNull",
		sCnName = "变态上颚",
		sEnName = "Metamorphic Mandible",
	},
	{
		sRawName = "item_dandelion_amulet",
		sShortName = "itemNull",
		sCnName = "蒲公英护符",
		sEnName = "Dandelion Amulet",
	},
	{
		sRawName = "item_enchanters_bauble",
		sShortName = "itemNull",
		sCnName = "附魔师之椟",
		sEnName = "Enchanter's Bauble",
	},
	{
		sRawName = "item_prophets_pendulum",
		sShortName = "itemNull",
		sCnName = "先知灵摆",
		sEnName = "Prophet's Pendulum",
	},
	{
		sRawName = "item_conjurers_catalyst",
		sShortName = "itemNull",
		sCnName = "咒术师触媒",
		sEnName = "Conjurer's Catalyst",
	},
	{
		sRawName = "item_dezun_bloodrite",
		sShortName = "itemNull",
		sCnName = "戴尊血仪",
		sEnName = "Dezun Bloodrite",
	},
	{ sRawName = "item_divine_regalia", sShortName = "itemNull", sCnName = "神圣宝饰", sEnName = "Divine Regalia" },
	{
		sRawName = "item_riftshadow_prism",
		sShortName = "itemNull",
		sCnName = "影墟棱晶",
		sEnName = "Riftshadow Prism",
	},
	{ sRawName = "item_harmonizer", sShortName = "itemNull", sCnName = "协和", sEnName = "Harmonizer" },
	{
		sRawName = "item_crippling_crossbow",
		sShortName = "itemNull",
		sCnName = "致残之弩",
		sEnName = "Crippling Crossbow",
	},
